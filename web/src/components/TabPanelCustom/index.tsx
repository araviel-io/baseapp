...
export enum HideModeCustom {
    hide = 'hide',
    unmount = 'unmount',
}

export type OnTabChangeCallbackCustom = (index: number, label?: string) => void;
...
export interface TabPanelPropsCustom {
    /**
 ...
 */
export const TabPanelCustom: React.FC<TabPanelPropsCustom> = ({
    fixed,
    hideMode = HideModeCustom.hide,
    panels,
    optionalHead,
    currentTabIndex,
    isDropdown,
    ...
    const renderTabContent = React.useCallback(
        (tab: TabCustom, index: number) => {
            const cn: string = classnames('cr-tab-content', {
                'cr-tab-content__active': hideMode === HideModeCustom.hide ? currentTabIndex === index : false,
            });
