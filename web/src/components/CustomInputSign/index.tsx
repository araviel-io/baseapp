...
export interface CustomInputSignProps {
    type: string;
    label: string;
    defaultLabel: string;
...
type Props = CustomInputSignProps;

class CustomInputSign extends React.Component<Props> {
    public render() {
        const {
            label,
            labelVisible,
        ...
        return (
            <React.Fragment>
                <div className="custom-input-sign">
