import { fr as mobileTranslationsFr } from '../../mobile/translations';
...
export const fr: LangType = {
    ...
    'page.header.navbar.wallets': 'Portefeuilles',
    ...
    'page.body.trade.header.yours': 'Mes trades',
    ...
    'page.body.trade.header.markets.content.last_price': 'Dernier prix',
    'page.body.trade.header.markets.content.change': 'Change',
    'page.body.trade.header.markets.content.search': 'Chercher',
    'page.body.trade.header.markets.content.volume': 'Volume',

    'page.body.trade.header.newOrder': 'Ordre',
    'page.body.trade.header.newOrder.content.tabs.buy': 'Acheter',
    'page.body.trade.header.newOrder.content.tabs.sell': 'Vendre',
    'page.body.trade.header.newOrder.content.orderType': 'Type d’ordre',
    ...
    'page.body.trade.header.newOrder.content.price': 'Prix',
    'page.body.trade.header.newOrder.content.triggerPrice': 'Trigger price {sign} Market p.',
    'page.body.trade.header.newOrder.content.amount': 'Montant',
    ...
    'page.body.trade.header.newOrder.locked.login.text': 'Connectez-vous pour utiliser cet échange',
    'page.body.trade.header.newOrder.locked.login.buttonText': 'Se connecter',
    ...
    'page.body.trade.header.recentTrades.content.time': 'Date',
    'page.body.trade.header.recentTrades.content.price': 'Prix',
    'page.body.trade.header.recentTrades.content.amount': 'Montant',

    'page.body.trade.header.openOrders': 'Mes ordres',
    ...
    'page.body.trade.header.openOrders.content.state': 'Etat',
    'page.body.trade.header.openOrders.content.price': 'Prix',
    'page.body.trade.header.openOrders.content.amount': 'Montant',
    'page.body.trade.header.openOrders.content.total': 'Valeur',
    'page.body.trade.header.openOrders.content.trigger': 'Declenchement',
    'page.body.trade.header.openOrders.content.filled': 'Complété',
    'page.body.trade.header.openOrders.hideOtherPairs': 'Cacher les autres pairs',
    'page.body.trade.header.openOrders.lastPrice': 'Dernier prix',
    ...
    'page.body.landing.header.button2': 'Connection',
    'page.body.landing.header.button3': 'S’enregistrer',

    'page.body.landing.marketInfo.title.text1': 'Tradez avec nous',
    'page.body.landing.marketInfo.title.text2': 'Plus de securité. Meilleure vie privée. Moins de stress.',
    'page.body.landing.marketInfo.title.button': 'Commencer',
    ...
    'page.body.landing.features.features.item1.title': 'Stockage en lieu sûr',
    'page.body.landing.features.features.item2.title': 'Securité',
    'page.body.landing.features.features.item3.title': '24/7 Support',
    'page.body.landing.features.features.item4.title': 'Communauté',
    'page.body.landing.features.features.item5.title': 'Communauté',
    ...
    'page.body.landing.tradeOnTheGo.item.text1': 'Notre plateforme optimise le trading sur n’importe quel appareil. Pas besoin de télécharger d’applications supplémentaires. Toute la puissance de SafeTrade, dans la paume de votre main.',
    ...
    'page.body.landing.tradeOnTheGo.item.button': 'Essayer',

    'page.body.landing.native.item.title': 'Crypto native',
    'page.body.landing.native.item.text1': 'Découvrez SafeCoin, crypto-monnaie et pair de base de SafeTrade pouvant atteindre les 60 000 transactions par seconde.',
    'page.body.landing.native.item.button': 'Découvrir',
    ...
    'page.body.landing.footer.exchange': 'Echanges',
    'page.body.landing.footer.wallets': 'Portefeuilles',
    'page.body.landing.footer.fees': 'Frais',
    'page.body.landing.footer.faq': 'FAQ',
    'page.body.landing.footer.support': 'Support',
    'page.body.landing.footer.privacy': 'Vie privée',
    'page.body.landing.footer.about': 'A propos',
    'page.body.landing.footer.community': 'Communauté',
    'page.body.landing.footer.info': 'Info',
    'page.body.landing.footer.rights': 'SafeTrade © Tous droits reservés.',

    'pagy.body.footer.powered_by': 'Powered by',


    /* Wallets */
    'page.body.wallets.estimated_value': 'Valeure estimée',

    'page.body.wallets.locked': 'Vérouillée',
    'page.body.wallets.balance': 'Solde',
    'page.body.wallets.tabs.deposit': 'Dépôt',
    'page.body.wallets.tabs.deposit.disabled.message': 'Dépôts désactivés par l\'administration',
    ...
    'page.body.wallets.tabs.deposit.ccy.message.submit': 'Déposez en utilisant l\'adresse ou le QR Code. Votre solde sera mis à jour après {confirmations} confirmations',
    'page.body.wallets.tabs.deposit.ccy.message.address': 'Addresse de dépôt',
    'page.body.wallets.tabs.deposit.ccy.message.button': 'COPIER',
    'page.body.wallets.tabs.deposit.ccy.message.success': 'Adresse copiée',
    'page.body.wallets.tabs.deposit.ccy.message.pending': 'Génération d\'une adresse de dépôt',
    'page.body.wallets.tabs.deposit.ccy.button.generate': 'Générer',
    'page.body.wallets.tabs.deposit.ccy.button.address': 'adresse',
    ...
    'page.body.wallets.table.pending': 'En attente',
    'page.body.wallets.table.rejected': 'Rejeté',
    'page.body.wallets.tabs.deposit.fiat.admin': ' To initiate a fiat withdrawal, please contact administrator!',

    'page.body.wallets.tabs.withdraw': 'Retrait',
    'page.body.wallets.tabs.withdraw.content.amount': 'Montant retrait',
    'page.body.wallets.tabs.withdraw.content.code2fa': 'Code 2FA',
    'page.body.wallets.tabs.withdraw.content.fee': 'Frais',
    'page.body.wallets.tabs.withdraw.content.total': 'Montant total du retrait',
    'page.body.wallets.tabs.withdraw.content.button': 'RETRAIT',
    'page.body.wallets.tabs.withdraw.disabled.message': 'Les retraits sont désactivés',
    'page.body.wallets.warning.withdraw.verification': 'Withdraws are allowed after passing KYC verification',
    'page.body.wallets.warning.withdraw.verification.button': 'Vérifiez votre compte',
    'page.body.wallets.warning.withdraw.2fa': 'Les retraits seront possibles après l\'activation du 2FA',
    'page.body.wallets.warning.withdraw.2fa.button': 'Activer 2FA',

    'page.body.wallets.tabs.withdraw.modal.confirmation': 'Confirmation du retrait',
    'page.body.wallets.tabs.withdraw.modal.message1': 'Vous recevrez  ',
    'page.body.wallets.tabs.withdraw.modal.message2': ' sur l\'adresse',
    'page.body.wallets.tabs.withdraw.modal.button.cancel': 'Annuler',
    'page.body.wallets.tabs.withdraw.modal.button.withdraw': 'Confirmer',

    'page.body.wallets.tabs.withdraw.content.enable2fa': 'Pour retirer vous devez activer le 2FA',
    'page.body.wallets.tabs.withdraw.content.enable2faButton': 'Activer le 2FA',
    ...
    'page.body.wallets.beneficiaries.title': 'Adresse de retrait :',
    'page.body.wallets.beneficiaries.fiat.title': 'Withdrawal details',
    'page.body.wallets.beneficiaries.dropdown.address': 'Address',
    'page.body.wallets.beneficiaries.dropdown.select': 'Sélectionner',
    'page.body.wallets.beneficiaries.dropdown.name': 'Libellé',
    'page.body.wallets.beneficiaries.dropdown.pending': 'En attente',
    ...
    'page.body.wallets.beneficiaries.addAddress': 'Ajouter une adresse',
    'page.body.wallets.beneficiaries.addAddressModal.header': 'Ajouter une nouvelle adresse de retrait',

    'page.body.wallets.beneficiaries.addAddressModal.body.coinAddress': 'Adresse Blockchain',
    'page.body.wallets.beneficiaries.addAddressModal.body.invalidAddress': 'Adresse invalide',
    'page.body.wallets.beneficiaries.addAddressModal.body.testnetAddress': 'WARNING! This is testnet address',
    'page.body.wallets.beneficiaries.addAddressModal.body.coinBeneficiaryName': 'Libellé',
    'page.body.wallets.beneficiaries.addAddressModal.body.coinDescription': 'Description (optionnel)',
    ...
    'page.body.history.deposit': 'Historique de dépôt',
    ...
    'page.body.history.deposit.header.amount': 'Montant',
    ...
    'page.body.history.withdraw': 'Historique de retrait',
    ...
    'page.body.history.withdraw.header.address': 'Adresse',
    'page.body.history.withdraw.header.amount': 'Montant',
    'page.body.history.withdraw.header.fee': 'Frais',
    ...
    'page.body.profile.header.account.username': 'Nom d\'utilisateur',
    'page.body.profile.header.account.content.password': 'Mot de passe',
    'page.body.profile.header.account.content.password.button.change': 'Changer',
    'page.body.profile.header.account.content.password.old': 'Ancien mot de passe',
    'page.body.profile.header.account.content.password.new': 'Nouveau mot de passe',
    'page.body.profile.header.account.content.password.button.save': 'Sauvegarder',
    'page.body.profile.header.account.content.password.button.cancel': 'Annuler',
    'page.body.profile.header.account.content.password.conf': 'Confirmation du mot de passe',
    'page.body.profile.header.account.content.password.dont.match': 'Les mots de passes ne correspondent pas',
    'page.body.profile.header.account.content.password.change.success': 'Succès !',
    'page.body.profile.header.account.content.password.change': 'Changer mot de passe',

    'page.body.profile.header.account.content.twoFactorAuthentication': '2FA',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.enable': 'Activé',
    'page.body.profile.header.account.content.twoFactorAuthentication.message.disable': 'Désactivé',
    ...
    'page.body.profile.header.account.content.twoFactorAuthentication.modalHeader': 'Identification à deux facteurs activée',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.header.signIn': 'Connection',
    'page.header.signIn.email': 'Email',
    'page.header.signIn.password': 'Mot de passe',
    'page.header.signIn.password.message.error': 'Mot de passe incorrect',
    ...
    'page.header.signIn.resetPassword.title': 'Reinitialisation du mot de passe',
    'page.header.signIn.resetPassword.newPassword': 'Nouveau mot de passe',
    'page.header.signIn.resetPassword.repeatPassword': 'Répéter mot de passe',
    'page.header.signIn.resetPassword.button': 'Changer',
    'page.header.signIn.resetPassword.error': 'Ne correspond pas',
    
    'page.header.signUpFromSignin': 'ou créez un compte',
    'page.header.signUp': 'S\'enregistrer',
    'page.header.signUp.username.minLength.error': '4 caractères minimum',
    'page.header.signUp.username.maxLength.error': '12 caractères maximum',
    'page.header.signUp.username.uniqueness.error': 'Nom d\'utilisateur déjà utilisé',
    'page.header.signUp.email': 'Email',
    'page.header.signUp.email.message.error': 'Email invalide',
    'page.header.signUp.password': 'Mot de passe',
    'page.header.signUp.password.message.error': 'Le mot de passe doit contenir au moins 8 caractères, au moins une majuscule et un chiffre',
    'page.header.signUp.confirmPassword': 'Confirmer le mot de passe',
    'page.header.signUp.confirmPassword.message.error': 'Les mots de passe ne correspondent pas',
    'page.header.signUp.referalCode': 'Code affilié (optionnel)',
    'page.header.signUp.terms': 'I have read and agree to the Terms of Service',
    'page.header.signUp.modal.header': 'CONFIRMEZ VOTRE ADRESSE MAIL',
    ...
    'page.header.signUp.strength.password': 'Complexité',
    'page.header.signUp.password.too.weak': 'TROP FAIBLE',
    'page.header.signUp.password.weak': 'FAIBLE',
    'page.header.signUp.password.good': 'BONNE',
    'page.header.signUp.password.strong': 'FORTE',
    'page.header.signUp.password.very.strong': 'TRES FORTE',
    ...
    'page.body.quick.exchange.sublabel.min_amount': 'Montant minimum',
    ...
    'page.body.500.maintenance': 'SafeTrade est en maintenance',
