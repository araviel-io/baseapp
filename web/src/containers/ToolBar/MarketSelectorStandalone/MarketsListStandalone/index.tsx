...
import { CurrentMarketInfo } from 'src/mobile/components';
...
class MarketsListStandaloneComponent extends React.Component<Props, State> {
    ...
    private mapMarkets() {
        ...
        return marketsMapped.reduce((pV, cV) => {
            ...
            const classname = classnames({
                'pg-dropdown-markets-list-container__positive fade-in-signin': isPositive,
            ...
            return [
                ...
                (<span style={{color: "var(--table-text-color)"}}><b>{Decimal.format(Number(market.volume), market.price_precision, ',')}</b></span>),
